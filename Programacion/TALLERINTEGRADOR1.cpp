...
int main()
{
  int opcion, buscando, i, num, promedio,mej;
  int posicion = -1;
  int suma = 0;
  int cont = 0;
  int nota[21];
  ...
  do
  {
    ...
    cout << "4.El estudiante con mejor calificacion del curso." << endl;
    cout << "5.Salir." << endl;
    cin >> opcion;
    switch (opcion)
    {
        ...
        for (i = 0; i < 21; i++)
          {
            ...
            if (num<7)
            {
              cout<<"El estudiante tiene que ir a clases de recuperacion obligatoriamente!!"<<endl;
            }
            else
            {
              cout << "El estudiante no tiene que ir a clases de recuperacion"<<endl;
            }
          }
            cout << endl;
            break;
            ...
            break;
            case 4:
            cout<<"En este apartado vamos a conocer cual es el estudiante con mayor nota del curso , pero para eso es nesecario ingresar nuevamente las notas de los estudiantes."<<endl;
            for (i = 0; i < 21; i++)
            {
              ...
              if (num==10)
              {
                cout<<"El estudiante con mayor nota del curso es: El estudiante"<<mej<<". Muchas felicidades!!"<<endl;
              }
              else
              {
                cout << "El estudiante" << mej << " no tiene la mejor nota del curso. Pero se puede lograrlo si se estudia!!"<<endl;
              }
            }
              cout << endl;
              break;
